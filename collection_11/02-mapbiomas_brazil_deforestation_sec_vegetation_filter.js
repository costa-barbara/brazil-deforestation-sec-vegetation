...
var asset_lulc = 'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/INTEGRATION/classification-ft';
var inputVersion = '0-2-tra-1';

var lulc = ee.ImageCollection(asset_lulc)
  .filter(ee.Filter.eq('version',asset_lulc))
  .mosaic();
...
var matrix_versions = [
  {
    name:'v01',
    description:'v01 -  1 ha na série toda para desmatamento e 1ha acumulado para Veg. Secundária e sem filtro do último ano', 
    annual_deforestation_size_filter: 11,
    accumulated_secondary_size_filter: 11,
    
  },
  
  // utilizados na coleção 10
  // {
  //   name:'v01',
