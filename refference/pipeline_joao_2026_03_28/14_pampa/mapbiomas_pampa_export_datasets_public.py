# -*- coding: utf-8 -*-
"""
Script for exporting MapBiomas Pampa coverage data to the GEE Data Catalog.
"""
...
# ================================
try:
    ee.Initialize(project='mapbiomas-pampa')
except Exception:
...
ASSET_TERRITORY = f'{PROJECT_TERRITORY_PATH}/TERRITORIES/PAMPA/WORKSPACE/POLITICAL_LEVEL_1/POLITICAL_LEVEL_1_v1'
...
# NOTE: Pampa public collection does not use 'lulc/' in the path
