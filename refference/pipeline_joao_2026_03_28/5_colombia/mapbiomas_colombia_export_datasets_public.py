...
ASSET_WATER_MONTHLY   = f'projects/mapbiomas-colombia/assets/WATER/COLLECTION-3-1/classification-monthly'
...
YEARS_WATER_MONTHLY   = list(range(1998, 2025))  # Monthly data available from 1998 to 2023
