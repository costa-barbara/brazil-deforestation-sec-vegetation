...
ASSET_TERRITORY = resolve_territory_asset(
    f'{PROJECT_TERRITORY_PATH}/TERRITORIES/{REGION_NAME.upper()}/WORKSPACE/POLITICAL_LEVEL_1/POLITICAL_LEVEL_1_v4'
)
...
VERSION_INPUT_DEF_SEC_VEG      = '6-1'
VERSION_PUBLIC_DEF_SEC_VEG     = 'v3'
...
VERSION_PUBLIC_WATER_SURFACE    = 'v2'

VERSION_INPUT_WATER_BODIES      = 1
VERSION_PUBLIC_WATER_BODIES     = 'v2'

VERSION_INPUT_WATER_MONTHLY      = 5
VERSION_PUBLIC_WATER_MONTHLY     = 'v2'
# ================================
# ASSET PATHS
# ================================
...
ASSET_DEF_SEC_VEG     = f'projects/mapbiomas-colombia/assets/DEFORESTATION/deforestation-secondary-vegetation'#-ft'
...
ASSET_WATER_SURFACE   = f'projects/mapbiomas-venezuela/assets/AGUA/SUPERFICIE/COLECCION3/POSTPROCESSING/Agua_Superficial_Anual_18Nov2025'
ASSET_WATER_BODIES    = f'projects/mapbiomas-venezuela/assets/AGUA/CUERPOS_HIDRICOS/Clasificacion_Multibanda_2000-2025'
ASSET_WATER_MONTHLY   = f'projects/mapbiomas-venezuela/assets/AGUA/SUPERFICIE/COLECCION3/POSTPROCESSING/Agua_Superficial_Mensual_11Nov'
...
PUBLIC_INTEGRATION     = f'{PUBLIC_COLLECTION}/mapbiomas_collection{COLLECTION_ID}0_integration_{VERSION_PUBLIC_INTEGRATION}'
...
YEARS_WATER_SURFACE   = list(range(2000, 2025))
YEARS_WATER_BODIES    = list(range(2000, 2025))
YEARS_WATER_MONTHLY   = list(range(2000, 2025))
