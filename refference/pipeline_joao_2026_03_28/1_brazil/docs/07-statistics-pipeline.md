...
**Causa:** Water asset não carrega ou não tem dados na região.

**Solução:**
1. Verificar se `ASSET_WATER_ANNUAL` existe com `earthengine asset info`
2. Executar `debug_water_data.py` para testar interseções
3. Conferir se water bands foram criadas corretamente
