...
ASSET_INTEGRATION     = f'{ASSET_COLLECTION}/INTEGRATION/country-integration' #projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-10_1/INTEGRATION/classification
...
TRANSITION_PERIODS = [
    ...
    (1990, 2024), (2000, 2024), (2008, 2024), (2010, 2024), (2012, 2024), # TODO: revisar para a indonesia
]
...
GROUP_SIZE_FILTER = 5 # (BR 33)               # applied to all years by default
GROUP_SIZE_EXCEPTION_FILTER = 5 # (BR 33)     # applied only to exception years (usually the last year)
