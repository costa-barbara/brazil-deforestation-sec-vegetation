...
ASSET_TERRITORY = F'{PROJECT_TERRITORY_PATH}/TERRITORIES-STAGING/{REGION_NAME.upper()}/WORKSPACE/POLITICAL_LEVEL_1/POLITICAL_LEVEL_1_v1'
...
ASSET_WATER_SURFACE   = f'projects/mapbiomas-bolivia/assets/WATER/COLLECTION-3/01-SURFACE/E03-INTEGRATION/water-integracion-01'
ASSET_WATER_BODIES    = f'projects/mapbiomas-bolivia/assets/WATER/COLLECTION-3/02-BODIES/INTEGRATION/water-classification-integracion-01'
ASSET_WATER_MONTHLY   = f'projects/mapbiomas-peru/assets/WATER/COLLECTION-3/FINAL-ASSETS/water-monthly-01'

ASSET_QUALITY         = 'projects/mapbiomas-workspace/COLECAO7/qualidade'

PUBLIC_COLLECTION       = f'{PROJECT_PUBLIC_PATH}/{REGION_NAME}/collection{COLLECTION_ID}'
PUBLIC_WATER_COLLECTION = f'{PROJECT_PUBLIC_PATH}/{REGION_NAME}/water/collection{WATER_COLLECTION_ID}'

PUBLIC_INTEGRATION     = f'{PUBLIC_COLLECTION}/mapbiomas_{REGION_NAME}_collection{COLLECTION_ID}_integration_{VERSION_PUBLIC_INTEGRATION}'
