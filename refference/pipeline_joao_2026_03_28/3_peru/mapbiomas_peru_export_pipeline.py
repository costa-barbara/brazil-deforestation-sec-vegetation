...
# ================================
try:
    ee.Initialize(project='mapbiomas-argentina')
except Exception:
...
ASSET_INTEGRATION     = f'projects/mapbiomas-public/assets/colombia/lulc/collection3/mapbiomas_colombia_collection3_coverage_v2'
ASSET_TRANSITIONS     = f'{ASSET_COLLECTION}/INTEGRATION/transitions'
ASSET_DEF_SEC_VEG     = f'projects/mapbiomas-colombia/assets/DEFORESTATION/deforestation-secondary-vegetation'
ASSET_DEF_SEC_VEG_FT  = f'projects/mapbiomas-colombia/assets/DEFORESTATION/deforestation-secondary-vegetation-ft'
ASSET_DEF_SEC_VEG_ANN = f'projects/mapbiomas-colombia/assets/DEFORESTATION/deforestation-secondary-vegetation-annual'
ASSET_DEF_SEC_VEG_ACC = f'projects/mapbiomas-colombia/assets/DEFORESTATION/deforestation-secondary-vegetation-accumulated'
ASSET_DEF_FREQ        = f'projects/mapbiomas-colombia/assets/DEFORESTATION/deforestation-frequency'
ASSET_SEC_VEG_AGE     = f'projects/mapbiomas-colombia/assets/DEFORESTATION/secondary-vegetation-age'
...
CLASS_LOOKUP = [
    ...
    [5, CLASS_PRIMARY_VEGETATION],          # 1.2. Mangrove
    [6, CLASS_PRIMARY_VEGETATION],          # 1.3. Floodable Forest
    [49, CLASS_PRIMARY_VEGETATION],         # 1.4. Wooded sand vegetation
    ...
    [74, CLASS_ANTHROPIC],                  # 3.2.3. Other crops
...
GROUP_SIZE_FILTER = 11               # applied to all years by default
GROUP_SIZE_EXCEPTION_FILTER = 11     # applied only to exception years (usually the last year)
...
RUN_DEF             = True
RUN_DEF_FT          = True
RUN_DEF_ANNUAL      = False
RUN_DEF_ACCUMULATED = False
RUN_DEF_FREQUENCY   = False
RUN_SV_AGE          = False
...
def export_transitions():
    ...
    """
    integration = ee.Image(ASSET_INTEGRATION)
