...
ASSET_TERRITORY = F'{PROJECT_TERRITORY_PATH}/TERRITORIES/{REGION_NAME.upper()}/WORKSPACE/POLITICAL_LEVEL_1/POLITICAL_LEVEL_1_v4'
...
RUN_EXPORT_WATER_SURFACE   = True
RUN_EXPORT_WATER_BODIES    = True
