# -*- coding: utf-8 -*-
"""
Script for exporting MapBiomas Uruguay coverage data to the GEE Data Catalog.
"""
...
# ================================
try:
    ee.Initialize(project='mapbiomas-uruguay')
except Exception:
...
ASSET_TERRITORY = f'{PROJECT_TERRITORY_PATH}/TERRITORIES/URUGUAY/WORKSPACE/POLITICAL_LEVEL_1/POLITICAL_LEVEL_1_v1'
